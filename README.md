...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YAPMIX/refacer/blob/master/notebooks/Refacer_colab.ipynb)
...
:warning: Please, before using the code from this repository, make sure to read the [disclaimer](https://github.com/YAPMIX/refacer/tree/main#disclaimer).
...
1. Clone the repository:
    ```bash
    git clone https://github.com/YAPMIX/refacer.git
    cd refacer
    ```
